...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 01 Apr 2020 pada 06.42
...
--
ALTER TABLE `alternatif`
  MODIFY `id_alternatif` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT untuk tabel `aspek_teknik`
--
ALTER TABLE `aspek_teknik`
  MODIFY `id_aspek_teknik` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;
